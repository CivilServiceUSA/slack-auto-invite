...
<html lang="en-us" class="no-js">
    ...
    <form id="signup-form" method="post" action="#" autocomplete="off">
        ...
        <input type="text" name="invite" id="invite" placeholder="Invite Code" maxlength="6" value="<?= $_REQUEST['invite']; ?>" pattern="[a-zA-Z0-9]{6}" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"<?php if(isset($_REQUEST['invite'])) echo 'readonly="readonly" style="display: none;"'; ?> />
